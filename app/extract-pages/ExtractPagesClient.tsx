...
export default function ExtractPagesClient() {
  ...
  const extract = async () => {
    ...
    try {
      ...
      const keepIndices = [...selected].sort((a, b) => a - b).map((p) => p - 1);
      ...
      a.href = url;
      a.download = fileName.replace(/\.pdf$/i, "") + "-extracted.pdf";
      a.click();
  ...
  const canExtract = selected.size > 0;
    ...
    return (
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "72px 24px" }}>
        ...
        <p style={{ color: MUTED, margin: "0 0 28px", lineHeight: 1.6 }}>
          Select the pages you want to keep. They will be saved as a new PDF.
        </p>
        <label
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      >
        ...
        <span style={{ fontSize: 14, fontWeight: 600 }}>Extract Pages</span>
        <span
          style={{
            fontSize: 13,
            color: MUTED,
        ...
        <button
          ...
          style={{
            background: canExtract ? RED : "#f0c8cc",
            color: "#fff",
            border: "none",
            borderRadius: 8,
            padding: "9px 18px",
      ...
      >
        Click pages to select the ones to keep. The rest will not be included.
        ...
        {thumb ? (
          <img
            ...
            style={{
              width: "100%",
              display: "block",
              opacity: isSelected ? 1 : hover ? 0.85 : 1,
              transition: "opacity 0.12s",
            }}
          />
        ) : (
          <div style={{ aspectRatio: "0.773", background: "#f3f4f6", width: "100%" }} />
        )}
        ...
        {!isSelected && hover && (
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "rgba(229,35,47,0.08)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
            }}
          ...
          >
            <div
              style={{
                ...
                fontSize: 20,
                fontWeight: 700,
                boxShadow: "0 2px 10px rgba(229,35,47,0.4)",
              }}
            >
              ✓
            </div>
